...
Date.prototype.endOfMonth = function (): Date {
    ...
    newDate.setDate(0); // the 0th day of the next month is the last day of the current month, because JS is weird
    return newDate;
};

Date.prototype.isStartOfMonth = function (): boolean {
