...
public static class DatabaseInstaller
{
    ...
    bool isWebApp)
  {
    ...
    services.AddScoped<ICustomDbContextFactory<BellemansDbContext>, BellemansDbContextFactory>(_ =>
      new BellemansDbContextFactory(connectionString));

    services.AddDbContext<BellemansDbContext>(options =>
    {
      options
      ...
      new BellemansDbContext(options.Options);
    });
